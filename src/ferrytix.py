...
style_scr.set_bg_color(lv.STATE.DEFAULT, Colors.BACKGROUND)
scr.add_style(lv.obj.PART.MAIN, style_scr)
head = lv.obj(scr)
head.set_size(1280, 200)
head.set_click(False)
style_head = lv.style_t()
style_head.set_bg_color(lv.STATE.DEFAULT, Colors.GRAY)
...
style_schedule.set_bg_color(lv.STATE.DEFAULT, Colors.GRAY2)
style_schedule.set_border_color(lv.STATE.DEFAULT, Colors.GRAY2)
...
style_buy_ticket.set_bg_color(lv.STATE.DEFAULT, Colors.GREEN)
...
style_buy_ticket_button_label.set_text_color(lv.STATE.DEFAULT, Colors.BACKGROUND)
...
style_recharge_membership_card.set_bg_color(lv.STATE.DEFAULT, Colors.BLUE)
...
style_recharge_membership_card_button_label.set_text_color(lv.STATE.DEFAULT, Colors.BACKGROUND)
...
style_information.set_bg_color(lv.STATE.DEFAULT, Colors.BLUE)
...
style_information_button_label.set_text_color(lv.STATE.DEFAULT, Colors.BACKGROUND)
